 ...
 *
 * Three things decide it, and they are the three a person would use: how
 * recently they tried, how many times they tried, and whether we have already
 * asked. Anyone who has paid is "customer" and out of the chasing ladder —
 * they are the audience for something else, never for "complete your payment".
 *
 * The thresholds are here rather than in people-labels.ts because they are a
 * judgement that will be argued with, not a name.
 */
function priorityOf(
  stage: PersonStage,
  lastAt: string,
