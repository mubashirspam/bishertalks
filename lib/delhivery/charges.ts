...
import { COURIER_DEFAULTS, parcelSize, type ParcelDimensionOverrides } from "@/lib/courier-sheet";
...
export const parcelGrams = (
  quantity: number,
  isGift = false,
  overrides?: ParcelDimensionOverrides | null
) => parcelSize(quantity, isGift, overrides).weightGrams;
