...
/**
 * The first day the 6th edition actually goes out, as YYYY-MM-DD.
 *
...
/**
 * What the 6th edition will cost once the pre-order window closes, in rupees.
 *
