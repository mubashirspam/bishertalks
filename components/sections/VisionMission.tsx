    ...
    <section className="py-20 bg-neutral-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-3xl p-8 md:p-10 border border-neutral-100 relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-neutral-900 mb-4 leading-tight">
              ...
              <div className="flex items-center gap-6">
                <div>
                  ...
                  <div className="text-sm text-neutral-500">Lives Impacted</div>
                </div>
          ...
          {/* Mission Card - Dark */}
          <div className="bg-neutral-900 rounded-3xl p-8 md:p-10 relative overflow-hidden group">
