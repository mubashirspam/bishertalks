    ...
    <section className="py-20 bg-neutral-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-7 bg-neutral-900 rounded-3xl p-8 md:p-10 relative overflow-hidden">
          ...
          <div className="lg:col-span-5 space-y-6">
            {callouts.map((callout, index) => (
              <div
                key={index}
                className="bg-white rounded-2xl p-6 md:p-8 border border-neutral-100 hover:border-primary-200 hover:shadow-lg transition-all duration-300 group"
              >
