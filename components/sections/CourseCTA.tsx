    ...
    <section className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          {/* Left Content */}
          <div>
            <span className="inline-flex items-center gap-2 px-4 py-1.5 bg-primary-100 rounded-full text-sm font-medium text-primary-700 mb-6">
            ...
            <div className="flex flex-wrap gap-6 mb-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-bold text-neutral-900">13+</p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-bold text-neutral-900">40+</p>
                  <p className="text-xs text-neutral-500">Video Lessons</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-bold text-neutral-900">18</p>
                  <p className="text-xs text-neutral-500">Worksheets</p>
                </div>
              </div>
            </div>
          ...
          <div className="relative">
            ...
            <div className="relative bg-white rounded-3xl p-6 shadow-xl border border-neutral-100">
              {/* Course Header */}
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="font-bold text-neutral-900">NLP Mastery Course</h3>
                  <p className="text-sm text-neutral-500">Neuro Linguistic Programming</p>
                </div>
              ...
              <div className="space-y-2">
                {[
                  ...
                  <div
                    key={index}
                    className="flex items-center gap-3 p-3 rounded-xl bg-neutral-50 hover:bg-primary-50 transition-colors"
                  >
                    ...
                    <span className="text-sm text-neutral-700 font-medium">{module}</span>
                    <Play className="w-3.5 h-3.5 text-neutral-400 ml-auto" />
                  </div>
                ))}
                <div className="flex items-center gap-3 p-3 rounded-xl bg-neutral-50">
                  <span className="w-7 h-7 bg-neutral-200 text-neutral-500 rounded-lg text-xs font-bold flex items-center justify-center flex-shrink-0">
                    +
                  </span>
                  <span className="text-sm text-neutral-500 font-medium">7 more modules...</span>
                </div>
              </div>
