...
import { courses, getTotalLessons, getTotalVideos, getTotalPdfs } from '@/lib/courses-data';

export const metadata = {
  title: 'Free Courses | BisherTalks',
  description: 'Free transformative courses by Bisher KC. Learn NLP, mindset coaching, and personal development through structured video lessons and downloadable resources.',
};
      ...
      <section className="bg-neutral-900 relative overflow-hidden">
        <div className="absolute inset-0 opacity-5">
          <svg width="100%" height="100%">
            <defs>
              <pattern id="courses-pattern" x="0" y="0" width="40" height="40" patternUnits="userSpaceOnUse">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 relative z-10">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-neutral-300 leading-relaxed">
              Structured courses designed to help you master your mindset, build confidence, and unlock your full potential. Completely free.
            </p>
          </div>
        </div>
      </section>
                ...
                <div className="bg-white rounded-2xl border border-neutral-200 overflow-hidden hover:shadow-xl hover:border-primary-200 transition-all duration-300">
                  ...
                  <div className="aspect-video bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900 relative overflow-hidden">
                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                      ...
                      <h3 className="text-xl font-bold text-white">{course.subtitle}</h3>
                    </div>
