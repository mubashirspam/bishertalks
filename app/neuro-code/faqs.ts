...
// Derived, not typed in. These answers name the deadline and the delivery
// window, and both are facts that live in lib/preorder.ts — a weekday written
// out here is one that goes quietly wrong the first time the date moves.
const DAY = launchOfferDayLabelMl();
const DAYS = PREORDER_DELIVERY_DAYS;
export const faqs = [
  {
  ...
  {
    q: "പ്രീ-ബുക്കിംഗ് എന്നാൽ എന്താണ്?",
    a: "ഇപ്പോൾ നടക്കുന്നത് നാലാം പതിപ്പിന്റെ പ്രീ-ബുക്കിംഗ് ആണ്. നിങ്ങൾ ഓർഡർ ചെയ്യുമ്പോൾ ഒരു കോപ്പി നിങ്ങൾക്കായി മാറ്റിവയ്ക്കുന്നു, അച്ചടി പൂർത്തിയായ ഉടൻ അയക്കും. NLP കോഴ്സ് മാത്രം കാത്തിരിക്കേണ്ട — അത് ഓർഡർ ചെയ്ത ഉടൻ ലഭിക്കും.",
  },
  {
    q: "പുസ്തകം എത്ര ദിവസത്തിനുള്ളിൽ ലഭിക്കും?",
    a: `നാലാം പതിപ്പിന്റെ അച്ചടി നടക്കുന്നതിനാൽ ${DAYS} ദിവസം വരെ എടുക്കാം. ഇന്ത്യയിൽ എവിടെയും ഡെലിവറി സൗജന്യമാണ്. ഓർഡർ ചെയ്ത ശേഷം ഓരോ ഘട്ടത്തിലും WhatsApp-ൽ അപ്ഡേറ്റ് ലഭിക്കും, ഒപ്പം ഓർഡർ ട്രാക്ക് ചെയ്യാനുള്ള ലിങ്കും. NLP കോഴ്സിന് കാത്തിരിക്കേണ്ട — അത് ഓർഡർ ചെയ്ത ഉടൻ ലഭിക്കും.`,
  },
  {
    q: "ഈ വില എത്ര നാൾ ഉണ്ടാകും?",
    a: `പ്രീ-ബുക്കിംഗ് വില ${DAY} വരെ മാത്രമാണ്. അതിന് ശേഷം നാലാം പതിപ്പിന്റെ വില വർധിക്കും.`,
  },
  {
