...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const description =
    `Order the 6th edition of Neuro Code by Bisher KC for ₹${pricing.payable} — the psychology & NLP book on rewriting your internal programming. ` +
    `Read by 12,000+ readers. Free 14-module NLP Mastery course unlocked the moment you order; ` +
