...
export const EDITION = "6th Edition";
 ...
 * the book being sold is the 6th edition and it is still being printed, so a
 ...
 *
 * The order it says things in is deliberate: the 6th edition is open for
...
export const PREORDER = {
  ...
  offerLead: "Neuro Code ആറാം പതിപ്പിനൊപ്പം NLP Mastery Course സൗജന്യം",
};
...
export const HERO = {
  ...
  cta: "ഇപ്പോൾ ആറാം പതിപ്പ് ഓർഡർ ചെയ്യാം",
  rating: "4.9",
  readers: "12,000+ വായനക്കാർ",
};
...
export const OFFER = {
  ...
  bookLine: "NEURO CODE — 6th EDITION",
...
export const FINAL_CTA = {
  ...
  sub: "ആറാം പതിപ്പ് · സൗജന്യ ഡെലിവറി · NLP കോഴ്‌സ് ഉടൻ",
};
