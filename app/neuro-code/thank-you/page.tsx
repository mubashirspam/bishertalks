...
export default async function ThankYouPage({
  ...
  // Shown only if this buyer has been set up as a referrer in admin. Most
  // haven't, and see nothing here.
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-neutral-900 border border-white/8 rounded-2xl p-6 mb-6 space-y-3">
          ...
          <p className="text-[11px] text-neutral-500 pt-1">
            6th edition — dispatched as soon as your order is confirmed.
